...
logger_args="--logger.save_dir runs/setup$setup/mbv2/$dataset/base"
...
python trainer_cls.py ${common_args} --logger.exp_name base_l43_${usr_group_kl} --model.num_of_finetune 43
python trainer_cls.py ${common_args} --logger.exp_name base_l44_${usr_group_kl} --model.num_of_finetune 44
python trainer_cls.py ${common_args} --logger.exp_name base_l45_${usr_group_kl} --model.num_of_finetune 45
python trainer_cls.py ${common_args} --logger.exp_name base_l46_${usr_group_kl} --model.num_of_finetune 46
python trainer_cls.py ${common_args} --logger.exp_name base_l47_${usr_group_kl} --model.num_of_finetune 47
python trainer_cls.py ${common_args} --logger.exp_name base_l48_${usr_group_kl} --model.num_of_finetune 48
python trainer_cls.py ${common_args} --logger.exp_name base_l49_${usr_group_kl} --model.num_of_finetune 49
python trainer_cls.py ${common_args} --logger.exp_name base_l50_${usr_group_kl} --model.num_of_finetune 50
python trainer_cls.py ${common_args} --logger.exp_name base_l51_${usr_group_kl} --model.num_of_finetune 51
python trainer_cls.py ${common_args} --logger.exp_name base_l52_${usr_group_kl} --model.num_of_finetune 52