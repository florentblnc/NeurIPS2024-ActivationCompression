...
# usr_group_kl=15.29
# load_args="--model.load pretrained_ckpts/mbv2/pretrain_15.29_cifar10/version_0/checkpoints/epoch=33-val-acc=0.966.ckpt"
...
# python trainer_cls.py ${common_args} --logger.exp_name filt_l43_r${radius}_${usr_group_kl} --model.num_of_finetune 43
# python trainer_cls.py ${common_args} --logger.exp_name filt_l44_r${radius}_${usr_group_kl} --model.num_of_finetune 44
# python trainer_cls.py ${common_args} --logger.exp_name filt_l45_r${radius}_${usr_group_kl} --model.num_of_finetune 45
# python trainer_cls.py ${common_args} --logger.exp_name filt_l46_r${radius}_${usr_group_kl} --model.num_of_finetune 46
# python trainer_cls.py ${common_args} --logger.exp_name filt_l47_r${radius}_${usr_group_kl} --model.num_of_finetune 47
# python trainer_cls.py ${common_args} --logger.exp_name filt_l48_r${radius}_${usr_group_kl} --model.num_of_finetune 48
# python trainer_cls.py ${common_args} --logger.exp_name filt_l49_r${radius}_${usr_group_kl} --model.num_of_finetune 49
# python trainer_cls.py ${common_args} --logger.exp_name filt_l50_r${radius}_${usr_group_kl} --model.num_of_finetune 50
# python trainer_cls.py ${common_args} --logger.exp_name filt_l51_r${radius}_${usr_group_kl} --model.num_of_finetune 51
# python trainer_cls.py ${common_args} --logger.exp_name filt_l52_r${radius}_${usr_group_kl} --model.num_of_finetune 52